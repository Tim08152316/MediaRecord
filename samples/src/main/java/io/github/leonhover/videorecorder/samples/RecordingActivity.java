...
public class RecordingActivity extends AppCompatActivity implements CameraView.CameraSurfaceListener {
    ...
    public static final String TEST_VIDEO_RECORDER_OUTPUT = "/sdcard/record_video/videorecorder_%d.mp4";
...
//    private static final int PREVIEW_HEIGHT = 480;
    ...
    private String createFileName() {
        ...
        return file.getAbsolutePath() + "/V-" + sdf.format(new java.util.Date()) + ".mp4";
    }

    private void startRecording() {
        Log.d(TAG, "startRecording");
        if (isSurfaceReady) {
            mVideoRecorder.setOutputFile(createFileName());
